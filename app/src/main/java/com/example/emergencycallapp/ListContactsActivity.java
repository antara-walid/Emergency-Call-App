...
public class ListContactsActivity extends AppCompatActivity {
    ...
    TextView no_data;
    ArrayList<String> contact_name, contact_num, contact_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter = new CustomAdapter(ListContactsActivity.this,this, contact_name, contact_num, contact_email);
